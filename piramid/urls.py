...
urlpatterns = [
    ...
    path('<int:referral_code>/', views.index, name='reg_ref'),
    path('earn/', views.earn, name='earn'),
    path('login/', views.user_login, name='login'),
    path('register/', views.register, name='register'),
    path('register/', views.register, name='register_ref'),
    ...
    path('stats/details-profit/', views.details_profit, name='details-profit')
